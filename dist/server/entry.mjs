...
import { N as NodeApp, g as deserializeManifest } from './chunks/astro.5936df6a.mjs';
...
const _page0  = () => import('./chunks/index@_@astro.d8e1423a.mjs');
const _page1  = () => import('./chunks/_pdf_@_@astro.acd1d177.mjs');
const _page2  = () => import('./chunks/404@_@astro.87138e35.mjs');
const _page3  = () => import('./chunks/_book_@_@astro.0c6eff3f.mjs');const pageMap = new Map([["src/pages/index.astro", _page0],["src/pages/pdfViewer/[pdf].astro", _page1],["src/pages/404.astro", _page2],["src/pages/[book].astro", _page3]]);
const _manifest = Object.assign(deserializeManifest({"adapterName":"@astrojs/node","routes":[{"file":"","links":[],"scripts":[{"type":"inline","value":"document.startViewTransition&&window.navigation.addEventListener(\"navigate\",t=>{const n=new URL(t.destination.url);location.origin===n.origin&&t.intercept({async handler(){const e=await(await fetch(n.pathname)).text(),[,o]=e.match(/<body>([\\s\\S]*)<\\/body>/i);document.startViewTransition(()=>{document.body.innerHTML=o,document.documentElement.scrollTop=0})}})});\n"}],"styles":[{"type":"external","src":"/_astro/404.9545d2fa.css"}],"routeData":{"route":"/","type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"inline","value":"document.startViewTransition&&window.navigation.addEventListener(\"navigate\",t=>{const n=new URL(t.destination.url);location.origin===n.origin&&t.intercept({async handler(){const e=await(await fetch(n.pathname)).text(),[,o]=e.match(/<body>([\\s\\S]*)<\\/body>/i);document.startViewTransition(()=>{document.body.innerHTML=o,document.documentElement.scrollTop=0})}})});\n"}],"styles":[{"type":"external","src":"/_astro/404.9545d2fa.css"}],"routeData":{"route":"/pdfviewer/[pdf]","type":"page","pattern":"^\\/pdfViewer\\/([^/]+?)\\/?$","segments":[[{"content":"pdfViewer","dynamic":false,"spread":false}],[{"content":"pdf","dynamic":true,"spread":false}]],"params":["pdf"],"component":"src/pages/pdfViewer/[pdf].astro","prerender":false,"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"inline","value":"document.startViewTransition&&window.navigation.addEventListener(\"navigate\",t=>{const n=new URL(t.destination.url);location.origin===n.origin&&t.intercept({async handler(){const e=await(await fetch(n.pathname)).text(),[,o]=e.match(/<body>([\\s\\S]*)<\\/body>/i);document.startViewTransition(()=>{document.body.innerHTML=o,document.documentElement.scrollTop=0})}})});\n"}],"styles":[{"type":"external","src":"/_astro/404.9545d2fa.css"}],"routeData":{"route":"/404","type":"page","pattern":"^\\/404\\/?$","segments":[[{"content":"404","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/404.astro","pathname":"/404","prerender":false,"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[{"type":"inline","value":"document.startViewTransition&&window.navigation.addEventListener(\"navigate\",t=>{const n=new URL(t.destination.url);location.origin===n.origin&&t.intercept({async handler(){const e=await(await fetch(n.pathname)).text(),[,o]=e.match(/<body>([\\s\\S]*)<\\/body>/i);document.startViewTransition(()=>{document.body.innerHTML=o,document.documentElement.scrollTop=0})}})});\n"}],"styles":[{"type":"external","src":"/_astro/404.9545d2fa.css"}],"routeData":{"route":"/[book]","type":"page","pattern":"^\\/([^/]+?)\\/?$","segments":[[{"content":"book","dynamic":true,"spread":false}]],"params":["book"],"component":"src/pages/[book].astro","prerender":false,"_meta":{"trailingSlash":"ignore"}}}],"base":"/","compressHTML":false,"markdown":{"drafts":false,"syntaxHighlight":"shiki","shikiConfig":{"langs":[],"theme":"github-dark","wrap":false},"remarkPlugins":[],"rehypePlugins":[],"remarkRehype":{},"gfm":true,"smartypants":true},"componentMetadata":[["C:/Users/captw/workspaces/Astro/Biblioteca. View Transitions API - Drive/biblioteca/src/pages/404.astro",{"propagation":"none","containsHead":true}],["C:/Users/captw/workspaces/Astro/Biblioteca. View Transitions API - Drive/biblioteca/src/pages/[book].astro",{"propagation":"none","containsHead":true}],["C:/Users/captw/workspaces/Astro/Biblioteca. View Transitions API - Drive/biblioteca/src/pages/index.astro",{"propagation":"none","containsHead":true}],["C:/Users/captw/workspaces/Astro/Biblioteca. View Transitions API - Drive/biblioteca/src/pages/pdfViewer/[pdf].astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var i=t=>{let e=async()=>{await(await t())()};\"requestIdleCallback\"in window?window.requestIdleCallback(e):setTimeout(e,200)};(self.Astro||(self.Astro={})).idle=i;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var s=(i,t)=>{let a=async()=>{await(await i())()};if(t.value){let e=matchMedia(t.value);e.matches?a():e.addEventListener(\"change\",a,{once:!0})}};(self.Astro||(self.Astro={})).media=s;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var r=(i,c,n)=>{let s=async()=>{await(await i())()},t=new IntersectionObserver(e=>{for(let o of e)if(o.isIntersecting){t.disconnect(),s();break}});for(let e of n.children)t.observe(e)};(self.Astro||(self.Astro={})).visible=r;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"\u0000@astrojs-ssr-virtual-entry":"_@astrojs-ssr-virtual-entry.mjs","\u0000@astro-renderers":"renderers.mjs","\u0000empty-middleware":"_empty-middleware.mjs","/src/pages/pdfViewer/[pdf].astro":"chunks/pages/_pdf_.astro.b5a54903.mjs","/src/pages/index.astro":"chunks/pages/index.astro.da4b9796.mjs","\u0000@astro-page:src/pages/index@_@astro":"chunks/index@_@astro.d8e1423a.mjs","\u0000@astro-page:src/pages/pdfViewer/[pdf]@_@astro":"chunks/_pdf_@_@astro.acd1d177.mjs","\u0000@astro-page:src/pages/404@_@astro":"chunks/404@_@astro.87138e35.mjs","\u0000@astro-page:src/pages/[book]@_@astro":"chunks/_book_@_@astro.0c6eff3f.mjs","/astro/hoisted.js?q=0":"_astro/hoisted.76f88837.js","astro:scripts/before-hydration.js":""},"assets":["/_astro/404.9545d2fa.css","/favicon.svg","/images/Artículo.jpg","/images/Astrofotografía. Unidad didáctica.png","/images/Astronomia 100 preguntas 100 respuestas.png","/images/Caminos entre las Constelaciones.png","/images/Discovering the Solar System.png","/images/Eclipses.png","/images/Globular Cluster Systems.png","/images/The Dynamic Lives of Globular Clusters.png","/images/The life of star clusters fron bith to dissolution.png"]}), {
	pageMap,
	renderers,
});
const _args = {"mode":"standalone","client":"file:///C:/Users/captw/workspaces/Astro/Biblioteca.%20View%20Transitions%20API%20-%20Drive/biblioteca/dist/client/","server":"file:///C:/Users/captw/workspaces/Astro/Biblioteca.%20View%20Transitions%20API%20-%20Drive/biblioteca/dist/server/","host":false,"port":3000};
